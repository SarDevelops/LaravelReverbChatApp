<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-slate-400 flex-1 sm:p-4 justify-between flex flex-col  rounded-t-lg">
        <div class="flex sm:items-center justify-between border-b-2 border-gray-400">
            <div class="relative flex items-center">
                <div class="relative " style="max-width: 20% !important">
                    <img src="{{ asset('storage/' . $user->image) }}" alt="" class="rounded-full w-24 ">
                </div>
    ...
    <div class="px-5 pt-3 bg-slate-950 rounded-b-lg">
